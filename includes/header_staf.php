...
<nav class="navbar navbar-expand-lg navbar-custom shadow">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Pimpinan Panel</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <div class="dropdown">
        <a class="btn btn-outline-light dropdown-toggle" href="profil.php" role="button" data-bs-toggle="dropdown">
          <i class="fa fa-user"></i> <?= htmlspecialchars($_SESSION['nama']); ?> (Pimpinan)
        </a>
